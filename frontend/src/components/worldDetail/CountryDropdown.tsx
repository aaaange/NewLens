...
import { MenuItem, Select, ListItemIcon, ListItemText, SelectProps } from "@mui/material";
...
const CountryDropdown: React.FC<CountryDropdownProps> = ({ width = "200px", height = "50px", ...props }) => {
  ...
  return (
      ...
      renderValue={(selected) => {
        ...
        return (
          <div className="flex items-center gap-2">
            <Flag code={country.code} fallback={<span>🏳️</span>} className="h-6 w-6" />
    ...
    >
      {g20Countries.map((country) => (
        <MenuItem key={country.code} value={country.code} className="!bg-transparent">
