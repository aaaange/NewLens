...
public class CountryService {
    ...
    public void listenDashboard(String message) {
        try {
            ...
            if (period == 1) {
                sentiment = processDailySentiment(newsDashboard);
                mentions = processDailyMentions(newsDashboard);
            } else if (period == 7) {
                sentiment = processWeeklySentiment(newsDashboard);
                mentions = processWeeklyMentions(newsDashboard);
            } else if (period == 30) {
                sentiment = processMonthlySentiment(newsDashboard);
                mentions = processMonthlyMentions(newsDashboard);
            } else {
