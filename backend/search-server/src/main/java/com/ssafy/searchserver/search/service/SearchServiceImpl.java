...
import com.ssafy.searchserver.search.repository.ForeignNewsMongoDBRepository;
...
public class SearchServiceImpl implements SearchService {
	...
	@Override
	public ForeignNewsListResponse getRelatedWords(String keyword, String category, int period) {
		try {
			...
			kafkaTemplate.send("related-keywords", json);
